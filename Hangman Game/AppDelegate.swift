...
//        UINavigationBar.appearance().barTintColor = UIColor(named: Constants.Colours.bgColour)
//        UINavigationBar.appearance().tintColor = UIColor(named: Constants.Colours.labelColour)
//        UINavigationBar.appearance().titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.white,
//                                                            NSAttributedString.Key.font: UIFont(name: Constants.Fonts.retroGaming, size: 22.0)!]
//        UINavigationBar.appearance().isTranslucent = false
//        UIBarButtonItem.appearance().setTitleTextAttributes([NSAttributedString.Key.font: UIFont(name: Constants.Fonts.retroGaming, size: 15.0)!], for: .normal)
//    }
